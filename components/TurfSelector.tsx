  ...
  return (
    <div className="relative">
      <button 
        ...
        className="flex items-center gap-2 px-3 py-1.5 bg-white border border-neutral-100 rounded-full shadow-sm active:scale-95 transition-all focus:outline-none"
      >
        ...
        <span className="text-[11px] font-bold text-neutral-800 uppercase tracking-tight truncate max-w-[120px]">
