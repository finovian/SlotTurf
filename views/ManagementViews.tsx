...
import { Check, ShieldCheck, HelpCircle, Mail, Phone, Trash2, CreditCard, Plus, MapPin, ChevronRight, Clock, IndianRupee } from 'lucide-react';
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-neutral-400 uppercase tracking-widest">
                  {turf.openingTime} - {turf.closingTime} • {formatCurrency(turf.hourlyPrice)}/hr
                </p>
              </div>
            </div>
...
}> = ({ turf, turfCount, onSave, onDelete }) => {
    ...
    <div className="py-6 space-y-6 animate-in fade-in duration-300">
      <div className="bg-neutral-900 rounded-4xl p-8 text-white space-y-6 shadow-2xl">
        <div className="flex justify-between items-start">
          ...
          <div className="bg-emerald-500/20 text-emerald-500 px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider">Active</div>
        </div>
        <div className="space-y-4 pt-4 border-t border-neutral-800">
          <div className="flex items-center gap-3">
            <Check size={16} className="text-emerald-500" />
            <span className="text-sm font-medium text-neutral-400">Unlimited Grounds</span>
          </div>
          <div className="flex items-center gap-3">
            <Check size={16} className="text-emerald-500" />
            <span className="text-sm font-medium text-neutral-400">WhatsApp Automations</span>
          </div>
          <div className="flex items-center gap-3">
            <Check size={16} className="text-emerald-500" />
            <span className="text-sm font-medium text-neutral-400">Advanced Admin Logic</span>
          </div>
        </div>
        <div className="pt-4 flex justify-between items-end">
          <div>
            <p className="text-[10px] font-bold text-neutral-500 uppercase tracking-widest">Renewal Date</p>
            <p className="font-bold">12 Oct 2025</p>
          </div>
          <p className="text-2xl font-bold">₹2,499<span className="text-xs text-neutral-500 font-medium">/yr</span></p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-3xl border border-neutral-100 p-8 space-y-6">
        <div className="space-y-2">
          ...
          <p className="text-sm text-neutral-500 font-medium leading-relaxed">Payments are secured by Razorpay. This subscription covers all grounds managed under this account.</p>
        </div>
        <button 
          onClick={handlePay}
          disabled={payLoading}
  ...
  return (
    <div className="py-6 space-y-8 animate-in fade-in duration-300">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-2xl font-bold text-neutral-900 tracking-tight text-center">How can we help?</h2>
        <p className="text-neutral-500 text-sm max-w-xs mx-auto text-center font-medium">Business support is available Mon-Fri, 10 AM to 7 PM IST.</p>
      </div>

      <div className="grid grid-cols-1 gap-4">
        <a href="mailto:support@turfflow.pro" className="bg-white border border-neutral-100 rounded-[28px] p-5 flex items-center gap-4 hover:bg-neutral-50 active:scale-95 transition-all">
          <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center">
            <Mail size={24} />
          </div>
          <div>
            <p className="text-sm font-bold text-neutral-900">Email Support</p>
            <p className="text-[10px] font-bold text-neutral-400 uppercase">support@turfflow.pro</p>
          </div>
        </a>
        <a href="tel:+919876543210" className="bg-white border border-neutral-100 rounded-[28px] p-5 flex items-center gap-4 hover:bg-neutral-50 active:scale-95 transition-all">
          <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center">
            <Phone size={24} />
          </div>
          <div>
            <p className="text-sm font-bold text-neutral-900">Phone Support</p>
            <p className="text-[10px] font-bold text-neutral-400 uppercase">+91 98765 43210</p>
          </div>
        </a>
      </div>
    </div>
